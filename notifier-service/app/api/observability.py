...
from app.api.metrics import ConsumerMetricsCollector
...
def create_observability_app(
    *,
    ...
    # Las dos criticas: sin Redis no hay de donde leer y sin Mongo no hay donde escribir.
    ...
    app.state.metrics = ConsumerMetricsCollector(stream=stream)
